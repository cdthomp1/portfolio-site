...
function displayResults(repo) {
  ...
  if (repo.homepage === null) {
    var liveLink = document.createElement("p");
    liveLink.innerText = `No Live link yet.`;
  } else {
    var liveLink = document.createElement("a");
    // var br = document.createElement("br"); WORK ON ADDING A BREAK
    liveLink.innerText = `View Project Live: ${repo.homepage}`;
